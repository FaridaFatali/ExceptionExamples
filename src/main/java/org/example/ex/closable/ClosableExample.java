package org.example.ex.closable;
...
public class ClosableExample {
    ...
    public static void run0() {
        ...
        System.out.println("After try block of run0() method");
    }
    ...
    public static void run1() {
        ...
        System.out.println("after try block of run1() method");
    }
    ...
    public static void run2() {
        ...
        System.out.println("After try block of run2() method");
    }
    ...
    public static void run3() {
        ...
        System.out.println("After try block of run3() method");
    }
